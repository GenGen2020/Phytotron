...
# Billing information: List of strings
bill_to_info = [
...
# Financial summary: Dictionary with string keys and string values
# Note: Assuming the monetary values are kept as strings for formatting purposes
financial_summary = {
    'basic': '169.00',
    'Other Taxes': '-101.40',
    'Amount Due': '67.60'
...
# Path to the logo image: String
image_path = 'static/image/logo.jpg'

# Invoice information: Dictionary with mixed types
invoice_info = {
    'Invoice No': 2147483647,  # Integer
    'Customer ID': 3,  # Integer
    'Invoice Date': datetime.date(2024, 3, 29),  # datetime.date object
    'Payment Terms': 'Due upon receipt',  # String
    'Currency': 'USD'  # String
}

# List of items or services provided: List of dictionaries
items_list = [
    {
        'Description': 'Greenhouse2',
        'Quantity': '39',  # Keeping as string based on your context, could be converted to int if necessary
        'Unit Price': Decimal('13.00'),  # Decimal for accurate financial calculations
        'Amount': Decimal('169.00'),  # Decimal for accurate financial calculations
        'Tax Code': 'HST'  # String
    }
]

# Output path for the generated PDF invoice: String
output_path = 'static/pdfs/order_2147483647.pdf'
create_pdf_with_image(output_path, image_path, items_list, financial_summary, invoice_info, bill_to_info)